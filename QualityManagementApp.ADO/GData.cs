...
namespace QualityManagementApp.ADO
{
    public class GData : GAbstractData
    {
        ...
        protected override string BuildInsertQueryByObject(object obj)
        {
            string ColumnNames = "";
            string Values = "";
            Type _type = obj.GetType();
        ...
        private protected override DataTable BuildTable(object obj, ref string condSQL)
        {
            string ConditionString = "";
            string Columns = "";
            Type _type = obj.GetType();
        ...
        private static string BuildSetForUpdate(string Values, string AtributeName, object AtributeValue, EntityProps entityprop)
        {
            switch (entityprop.DATA_TYPE)
            {
                ...
                case "varchar":
                case "char":
                    Values = Values + AtributeName + " = '" + AtributeName.ToString() + "',";
                    break;
